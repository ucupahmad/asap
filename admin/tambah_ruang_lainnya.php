...
<head>
<meta charset="UTF-8">
<title>Tambah Ruang belajar</title>
...
<div class="container mt-5">
  <div class="card shadow">
    <div class="card-header bg-info text-white">
      <h5 class="mb-0"><i class="bi bi-plus-circle"></i> Tambah Data Ruang belajar</h5>
    </div>
    <div class="card-body">
      <form method="post" action="simpan_ruang_lainnya.php">
        <div class="mb-3">
